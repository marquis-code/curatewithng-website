...
import { useLogger, isNuxtMajorVersion, addTypeTemplate, defineNuxtModule, createResolver, addImports, addServerImports, addPlugin, extendRouteRules, addPrerenderRoutes, addServerHandler, addServerPlugin, addServerImportsDir } from '@nuxt/kit';
...
function registerTypeTemplates({ nuxt }) {
  const nitroModules = isNuxtMajorVersion(4, nuxt) ? ["nitropack", "nitropack/types"] : ["nitropack"];
  addTypeTemplate({
