...
import { defineComponent, ref, reactive, mergeProps, unref, isRef, withCtx, createVNode, toDisplayString, openBlock, createBlock, createCommentVNode, useSSRContext } from 'file:///Users/marquis/curatewithng/website/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderList, ssrRenderAttr, ssrRenderClass } from 'file:///Users/marquis/curatewithng/website/node_modules/vue/server-renderer/index.mjs';
import { Star, PackageSearch } from 'file:///Users/marquis/curatewithng/website/node_modules/lucide-vue-next/dist/cjs/lucide-vue-next.js';
import { a as useSeoMeta, G as GATEWAY_ENDPOINT } from './server.mjs';
  ...
  setup(__props) {
    ...
    const fetchGifts = async () => {
      ...
      try {
        ...
        totalResults.value = ((_a = payload.meta) == null ? void 0 : _a.total) || gifts.value.length;
        totalPages.value = ((_b = payload.meta) == null ? void 0 : _b.totalPages) || 1;
      } catch (e) {
...
//# sourceMappingURL=explore-23UMqPhS.mjs.map
