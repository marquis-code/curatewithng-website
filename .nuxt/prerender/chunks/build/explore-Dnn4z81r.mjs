...
import { defineComponent, ref, reactive, mergeProps, unref, withCtx, createVNode, toDisplayString, openBlock, createBlock, createCommentVNode, useSSRContext } from 'file:///Users/marquis/curatewithng/website/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderAttr, ssrIncludeBooleanAttr, ssrLooseContain, ssrLooseEqual, ssrRenderList, ssrInterpolate, ssrRenderComponent, ssrRenderClass } from 'file:///Users/marquis/curatewithng/website/node_modules/vue/server-renderer/index.mjs';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(loading)) {
              ...
              if (_push2) {
                ...
                return [
                  createVNode("div", { class: "aspect-square bg-slate-100 overflow-hidden" }, [
                    createVNode("img", {
                      src: ((_b = gift.images) == null ? void 0 : _b[0]) || "/placeholder-gift.jpg",
                      alt: gift.name,
        ...
        _push(`<div class="text-center py-20"><div class="text-6xl mb-4">\u{1F50D}</div><h3 class="text-xl font-heading font-bold text-slate-900 mb-2">No gifts found</h3><p class="text-slate-500 mb-6">Try adjusting your filters or search terms</p><button class="btn-primary">Reset Filters</button></div>`);
      }
...
//# sourceMappingURL=explore-Dnn4z81r.mjs.map
