...
import { defineComponent, ref, computed, mergeProps, unref, withCtx, createTextVNode, createVNode, openBlock, createBlock, toDisplayString, useSSRContext } from 'file:///Users/marquis/curatewithng/website/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderAttr, ssrRenderList, ssrRenderClass, ssrInterpolate } from 'file:///Users/marquis/curatewithng/website/node_modules/vue/server-renderer/index.mjs';
import { Star, ShoppingCart } from 'file:///Users/marquis/curatewithng/website/node_modules/lucide-vue-next/dist/cjs/lucide-vue-next.js';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(loading)) {
        ...
        _push(`<div class="text-center py-20"><div class="text-6xl mb-4">\u{1F615}</div><h1 class="text-2xl font-heading font-bold text-slate-900 mb-2">Gift Not Found</h1><p class="text-slate-500 mb-6">The gift you&#39;re looking for doesn&#39;t exist or is no longer available.</p>`);
        ...
        if (((_a = unref(gift).images) == null ? void 0 : _a.length) > 1) {
...
//# sourceMappingURL=_slug_-D7fyYKWb.mjs.map
