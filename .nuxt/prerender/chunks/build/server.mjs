import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { hasInjectionContext, inject, ref, getCurrentInstance, reactive, markRaw, effectScope, isRef, isReactive, toRef, toRaw, nextTick, getCurrentScope, onScopeDispose, watch, toRefs, computed, defineComponent, createElementBlock, shallowRef, provide, cloneVNode, h, defineAsyncComponent, unref, shallowReactive, Suspense, Fragment, useSSRContext, createApp, withCtx, createVNode, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, mergeProps, isReadonly, isShallow } from 'file:///Users/marquis/curatewithng/website/node_modules/vue/index.mjs';
import { $fetch } from 'file:///Users/marquis/curatewithng/website/node_modules/ofetch/dist/node.mjs';
...
import { getContext, executeAsync } from 'file:///Users/marquis/curatewithng/website/node_modules/unctx/dist/index.mjs';
import { getRequestHeader, sanitizeStatusCode, setCookie, getCookie, deleteCookie, createError as createError$1, appendHeader } from 'file:///Users/marquis/curatewithng/website/node_modules/h3/dist/index.mjs';
import { useRoute as useRoute$1, RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'file:///Users/marquis/curatewithng/website/node_modules/vue-router/vue-router.node.mjs';
import { defu } from 'file:///Users/marquis/curatewithng/website/node_modules/defu/dist/defu.mjs';
import { parseURL, encodePath, decodePath, hasProtocol, isScriptProtocol, joinURL, withQuery } from 'file:///Users/marquis/curatewithng/website/node_modules/ufo/dist/index.mjs';
import { klona } from 'file:///Users/marquis/curatewithng/website/node_modules/klona/dist/index.mjs';
import { ssrRenderComponent, ssrRenderSuspense, ssrRenderVNode } from 'file:///Users/marquis/curatewithng/website/node_modules/vue/server-renderer/index.mjs';
import { parse } from 'file:///Users/marquis/curatewithng/website/node_modules/nuxt/node_modules/cookie-es/dist/index.mjs';
import destr from 'file:///Users/marquis/curatewithng/website/node_modules/destr/dist/index.mjs';
import { isEqual } from 'file:///Users/marquis/curatewithng/website/node_modules/ohash/dist/index.mjs';
import axios from 'file:///Users/marquis/curatewithng/website/node_modules/axios/index.js';
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-BwNyslsM.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-CM8l6_CI.mjs'));
