...
import { join } from 'file:///Users/marquis/curatewithng/website/node_modules/pathe/dist/index.mjs';

async function readSourcesFromFilesystem(filename) {
  if (!true) {
    return null
  }
  const path = join("/Users/marquis/curatewithng/website/node_modules/.cache/nuxt/sitemap", filename);
