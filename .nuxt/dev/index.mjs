...
import { escapeHtml } from 'file:///Users/marquis/curatewithng/website/node_modules/@vue/shared/dist/shared.cjs.js';
import viteNodeEntry_mjs from 'file:///Users/marquis/curatewithng/website/node_modules/@nuxt/vite-builder/dist/vite-node-entry.mjs';
import { viteNodeFetch } from 'file:///Users/marquis/curatewithng/website/node_modules/@nuxt/vite-builder/dist/vite-node.mjs';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file:///Users/marquis/curatewithng/website/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, hasProtocol, withHttps, withoutTrailingSlash, withTrailingSlash, decodePath, withLeadingSlash, withBase, parsePath, stringifyQuery, parseQuery, encodePath, stringifyParsedURL, joinRelativeURL } from 'file:///Users/marquis/curatewithng/website/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file:///Users/marquis/curatewithng/website/node_modules/vue/server-renderer/index.mjs';
import destr, { destr as destr$1 } from 'file:///Users/marquis/curatewithng/website/node_modules/destr/dist/index.mjs';
import { createHooks } from 'file:///Users/marquis/curatewithng/website/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file:///Users/marquis/curatewithng/website/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///Users/marquis/curatewithng/website/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, defineDriver, prefixStorage } from 'file:///Users/marquis/curatewithng/website/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/marquis/curatewithng/website/node_modules/unstorage/drivers/fs.mjs';
import fsDriver from 'file:///Users/marquis/curatewithng/website/node_modules/unstorage/drivers/fs-lite.mjs';
import lruCache from 'file:///Users/marquis/curatewithng/website/node_modules/unstorage/drivers/lru-cache.mjs';
import { digest, hash as hash$1 } from 'file:///Users/marquis/curatewithng/website/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///Users/marquis/curatewithng/website/node_modules/klona/dist/index.mjs';
import defu, { defuFn, defu as defu$1, createDefu } from 'file:///Users/marquis/curatewithng/website/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///Users/marquis/curatewithng/website/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///Users/marquis/curatewithng/website/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/marquis/curatewithng/website/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { createConsola, consola as consola$1 } from 'file:///Users/marquis/curatewithng/website/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///Users/marquis/curatewithng/website/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///Users/marquis/curatewithng/website/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///Users/marquis/curatewithng/website/node_modules/source-map/source-map.js';
import devalue from 'file:///Users/marquis/curatewithng/website/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { toValue, isVNode, isRef } from 'file:///Users/marquis/curatewithng/website/node_modules/vue/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { stringify, uneval } from 'file:///Users/marquis/curatewithng/website/node_modules/devalue/index.js';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///Users/marquis/curatewithng/website/node_modules/errx/dist/index.js';
import _wH6JrtIxmaSoA8lCPWFnE9z4lQeXW6H5z3l5aymEQw from 'file:///Users/marquis/curatewithng/website/node_modules/@nuxt/vite-builder/dist/fix-stacktrace.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$2, isAbsolute } from 'file:///Users/marquis/curatewithng/website/node_modules/pathe/dist/index.mjs';
import { createFilter } from 'file:///Users/marquis/curatewithng/website/node_modules/nuxtseo-shared/dist/utils.mjs';
...
import { ipxFSStorage, ipxHttpStorage, createIPX, createIPXH3Handler } from 'file:///Users/marquis/curatewithng/website/node_modules/ipx/dist/index.mjs';

const serverAssets = [{"baseName":"server","dir":"/Users/marquis/curatewithng/website/server/assets"}];
...
const _47Users_47marquis_47curatewithng_47website_47node_modules_47_64nuxt_47nitro_45server_47dist_47runtime_47utils_47cache_45driver_46js = defineDriver(
  /**
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/marquis/curatewithng/website","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/marquis/curatewithng/website/server","watchOptions":{"ignored":[null]}}));
storage.mount('cache:nuxt:payload', _47Users_47marquis_47curatewithng_47website_47node_modules_47_64nuxt_47nitro_45server_47dist_47runtime_47utils_47cache_45driver_46js({"driver":"/Users/marquis/curatewithng/website/node_modules/@nuxt/nitro-server/dist/runtime/utils/cache-driver.js","base":"/Users/marquis/curatewithng/website/.nuxt/cache/nuxt/payload"}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/marquis/curatewithng/website/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/marquis/curatewithng/website/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/marquis/curatewithng/website/.data/kv"}));
...
const _inlineRuntimeConfig = {
  ...
  "ipx": {
    ...
    "fs": {
      "dir": [
        "/Users/marquis/curatewithng/website/public"
      ]
    },
    "http": {
      "domains": []
...
const _Z3U0qTBpIq6MTBJpX1JJXmUHk6v_A_aLWi9gTNZc60 = (function(nitro) {
...
const _57R297M9Lnef9nIAvlPphxCNNd4w6v6q9wJrNInkCQ = defineNitroPlugin(async (nitroApp) => {
...
const _d0SCIpbY695BOIZgn36dijgN6IoUWRcvL8hYjx4Rnc = defineNitroPlugin(async (nitroApp) => {
...
const rootDir = "/Users/marquis/curatewithng/website";

const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description","content":"AI-powered gifting curation platform for Nigeria. Get personalized gift recommendations for birthdays, weddings, corporate events, and more."},{"name":"theme-color","content":"#6B21A8"},{"property":"og:title","content":"CurateWithNG — The Smartest Way to Gift in Nigeria"},{"property":"og:description","content":"AI-powered gifting curation platform. Find the perfect gift for every occasion."},{"property":"og:type","content":"website"},{"property":"og:url","content":"https://curatewithng.com"}],"link":[{"rel":"preconnect","href":"https://fonts.googleapis.com"},{"rel":"preconnect","href":"https://fonts.gstatic.com","crossorigin":""},{"rel":"stylesheet","href":"https://fonts.googleapis.com/css2?family=Outfit:wght@400;500;600;700;800&family=DM+Sans:wght@300;400;500;600;700&family=JetBrains+Mono:wght@400;500&display=swap"}],"style":[],"script":[],"noscript":[],"title":"CurateWithNG — The Smartest Way to Gift in Nigeria"};
...
const _TyqoJaPCVzIDYV5dlC_SslkkzgvVeRzxEw4aUUjmRM0 = (nitroApp) => {
...
const plugins = [
  _Z3U0qTBpIq6MTBJpX1JJXmUHk6v_A_aLWi9gTNZc60,
_57R297M9Lnef9nIAvlPphxCNNd4w6v6q9wJrNInkCQ,
_d0SCIpbY695BOIZgn36dijgN6IoUWRcvL8hYjx4Rnc,
_TyqoJaPCVzIDYV5dlC_SslkkzgvVeRzxEw4aUUjmRM0,
...
const _YPUtkQ = eventHandler((event) => {
...
const _Jl9mbj = eventHandler(async (e) => {
  if (e.context._initedSiteConfig)
    return;
...
const _IkO524 = eventHandler(async (e) => {
...
async function parseSitemapIndex(xml) {
  ...
  const { XMLParser } = await import('file:///Users/marquis/curatewithng/website/node_modules/fast-xml-parser/src/fxp.js');
...
const _LgaoxN = defineEventHandler(async (e) => {
...
const _O8kqII = defineEventHandler(async (e) => {
...
const _SYadqv = defineEventHandler(async (e) => {
...
const _K1EImI = defineEventHandler(sitemapXmlEventHandler);

const _s9kdDc = defineEventHandler(async (e) => {
  const nitroApp = useNitroApp();
...
const _0QC2v0 = defineEventHandler(async (e) => {
...
const _YKOMWk = defineEventHandler(async (e) => {
...
const _HXm39v = defineEventHandler(async (e) => {
  const query = getQuery$1(e);
...
const _4wNpoe = defineEventHandler(async (e) => {
  const { url, mode } = getQuery$1(e);
  if (!url || typeof url !== "string")
...
const _Oq158Q = lazyEventHandler(() => {
...
const _lazy_uz6MJc = () => Promise.resolve().then(function () { return renderer; });

const handlers = [
  { route: '', handler: _YPUtkQ, lazy: false, middleware: true, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_uz6MJc, lazy: true, middleware: false, method: undefined },
  { route: '', handler: _Jl9mbj, lazy: false, middleware: true, method: undefined },
  { route: '/__site-config__/debug.json', handler: _IkO524, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/debug.json', handler: _LgaoxN, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/debug-production.json', handler: _O8kqII, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/style.xsl', handler: _SYadqv, lazy: false, middleware: false, method: undefined },
  { route: '/sitemap.xml', handler: _K1EImI, lazy: false, middleware: false, method: undefined },
  { route: '/robots.txt', handler: _s9kdDc, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _0QC2v0, lazy: false, middleware: true, method: undefined },
  { route: '/__robots__/debug.json', handler: _YKOMWk, lazy: false, middleware: false, method: undefined },
  { route: '/__robots__/debug-path.json', handler: _HXm39v, lazy: false, middleware: false, method: undefined },
  { route: '/__robots__/debug-production.json', handler: _4wNpoe, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: handler$1, lazy: false, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _Oq158Q, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_uz6MJc, lazy: true, middleware: false, method: undefined }
];
...
const sources$1 = [
    {
        ...
        "urls": [
            ...
            {
                "loc": "/dashboard/orders"
            },
            {
                "loc": "/dashboard/requests"
            },
            {
                "loc": "/dashboard/wishlist"
            },
            {
                "loc": "/dashboard/recipients"
            },
            {
